...
export default function addEventListener(PushAllRecipeFind) {
  ...
  const mainSearchSvg = document.querySelector(
    ".mainsearch_search-label svg path"
  );
  ...
  const allTagCloseCross = document.querySelectorAll(
    ".recipeTags_ingredient-button,.recipeTags_device-button,.recipeTags_ustensils-button"
  );
