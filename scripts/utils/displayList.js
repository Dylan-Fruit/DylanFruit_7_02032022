export default function displayList(){
    ...
    const showList = (type) =>{
        ...
        const searchFieldLabel = document.querySelector(`.search_${type}-combox-searchfieldLabel`);
    ...
    function toggleIngredient() {
        if(!containersList[0].getAttribute("style") || containersList[0].getAttribute("style") === "display: none;"){
            showList("ingredient");
            hideList("ustensils");
            hideList("device");
        } else {
    ...
    function toggleDevice() {
        if(!containersList[1].getAttribute("style") || containersList[1].getAttribute("style") === "display: none;"){
            showList("device");
            hideList("ingredient");
            hideList("ustensils");
        } else{
    ...
    function toggleUstensils() {
        if(!containersList[2].getAttribute("style") || containersList[2].getAttribute("style") === "display: none;"){
            showList("ustensils");
            hideList("ingredient");
            hideList("device");
        } else {
